...
$i = 0;
$qry = "SELECT * , (start - INTERVAL 15 MINUTE) as quince_min,  (start - INTERVAL 10 MINUTE) as diez_min, (start - INTERVAL 5 MINUTE) as cinco_min , (start - INTERVAL 1 MINUTE) as un_min FROM calendario_esp where hour(start) = '$hora' and day(start) = '$dia' and month(start) = '$mes' and year(start) = '$anio' and notificado <> 1 and anulado  <> 1  ;";
