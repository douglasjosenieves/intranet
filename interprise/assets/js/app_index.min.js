...
$.ajax({
	url: '../async/contactos_nuevos_user.php',
	type: 'POST',
	dataType: 'html',
...
.done(function(data) {
	...
	numberfin = number.length -2;
	console.log('Contactos nuevos:'+numberfin);
	$('#contactos_nuevos_user').html(data) ;

	if (numberfin!=0) {
	$('#contactos_nuevos_total_user').html(numberfin) ;
	$('#contactos_nuevos_total1_user').html(numberfin) ;
}
