...
$qry2 = "INSERT INTO chat (`id_para`, `id_de`, `mensaje`, `fecha_envio`, `ip`) SELECT id , '".$id_usuario."', '".'Calendario recordatorio: Titulo:'.$titulo.' Nombre:'.$nombre.' '.$tipo.' '.$descripcion."', '".$fecha."', '".$ip."' FROM usuarios where anulado <> 1 and tipo = 'administrador';";
