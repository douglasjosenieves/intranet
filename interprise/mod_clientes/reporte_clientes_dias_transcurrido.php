...
<head>
	...
	<title>Clientes por días transcurrido</title>
...
<body>
	...
	<div class="pageWrap">
		...
		<div class="pageContent extended">
			<div class="container">
				<h1 class="pageTitle">
					<a href="#" title="#">Clientes por días transcurrido</a>
				</h1>
				<ol class="breadcrumb">
...
if (isset($_GET['status'])) {
	...
	$resul =  mysql_query("SELECT *, datediff(now(),date(editado_fecha)) as dia FROM `contactos_web` where anulado <> 1 and status = '".$_GET['status']."'");
	# code...
}
...
$resul =  mysql_query("SELECT *, datediff(now(),date(editado_fecha)) as dia FROM `contactos_web` where anulado <> 1");
					...
					$opciones['opciones'][]=$row;
					  ...
					  $dias = $fechaphp - $opciones['opciones'][$i]['editado_fecha'];
					 ?>
					...
					<tr>
					    ...
					    <td><?php echo $opciones['opciones'][$i]['dia']; ?></td>
