...
$status ='';
				...
				$resulv =  mysql_query("SELECT distinct(procedencia_publicitaria) FROM contactos_web");
				while($rowv =  mysql_fetch_array($resulv) ) { 
$status .= '<option value="';
$status .= $rowv['procedencia_publicitaria'];
$status .= '">';
$status .= strtoupper($rowv['procedencia_publicitaria']);
$status .= '</option>';
...
<head>
	...
	<title>Clientes por procedencia publicitaria</title>
...
<body>
	...
	<div class="pageWrap">
		...
		<div class="pageContent extended">
			<div class="container">
				<h1 class="pageTitle">
					<a href="#" title="#">Clientes por cartera</a>
				</h1>
				<ol class="breadcrumb">
					...
					<div class="tableWrap dataTable table-responsive js-select">
							...
							<thead>
								<tr>
									...
									<th>email</th>
									<th>Asesor</th>
									<th>Procedencia publicitaria</th>
									<th>Procesos</th>
...
if (isset($_GET['status'])) {
	...
	$resul =  mysql_query("SELECT * FROM `contactos_web` where anulado <> 1 and procedencia_publicitaria = '".$_GET['status']."'");
	# code...
}
...
$resul =  mysql_query("SELECT * FROM `contactos_web` where anulado <> 1");
					...
					<tr>
					    ...
					    <td><?php echo $opciones['opciones'][$i]['procedencia_publicitaria']; ?></td>
					    <td>
...
$(document).ready(function() {
 ...
 jQuery(document).ready(function($) {
  ...
  window.location="?status="+seleccion+"";
