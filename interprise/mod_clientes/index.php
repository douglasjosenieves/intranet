...
<div class="row">
					...
					<input type="text"   value="<?php echo $data['data'][0]['clave'] ?>" class="form-control" name="clave" id="clave" placeholder="Clave">
					</div>
					</div>
...
$('#nacionalidad').val('<?php echo $data['data'][0]['nacionalidad'] ?>').change();
