...
$resul =  mysql_query("SELECT * FROM  contactos_web where anulado <> 1 and nombres like '%".$texto."%'  OR  apellidos like '%".$texto."%'  ");
	...
	<li class="manito contactos" data-nacionalidad="<?php echo $opciones['contacto'][$i]['nacionalidad'] ?>" data-id="<?php echo $opciones['contacto'][$i]['id'] ?>" data-nombre="<?php echo $opciones['contacto'][$i]['nombres'].' '.$opciones['contacto'][$i]['apellidos'] ?>" data-documento="<?php echo $opciones['contacto'][$i]['documento'] ?>" data-direccion="<?php echo $opciones['contacto'][$i]['direccion_domicilio'] ?>" data-tel="<?php echo $opciones['contacto'][$i]['movil'] ?>" data-email="<?php echo $opciones['contacto'][$i]['email'] ?>" data-fechacontratacion="<?php echo $opciones['contacto'][$i]['fecha_contratacion'] ?>" title="<?php echo $opciones['contacto'][$i]['nombres'].' '.$opciones['contacto'][$i]['apellidos'] ?>" > <?php echo $opciones['contacto'][$i]['id'].' '.$opciones['contacto'][$i]['nombres'].' '.$opciones['contacto'][$i]['apellidos'] ?></li>
