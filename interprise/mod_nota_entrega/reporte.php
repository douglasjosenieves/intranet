...
<body>
	...
	<div class="pageWrap">
		...
		<div class="pageContent extended">
			<div class="container">
				<h1 class="pageTitle">
					<a href="#" title="#">Notas de entrega </a>
				</h1>
				<ol class="breadcrumb">
					 ...
					 <!-- Button Extra small -->
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a href="../mod_nota_entrega/ver.php?tipo=editar&id=<?php echo $opciones['opciones'][$i]['id']; ?>" title="#"><i class="fa fa-eye"></i> Gestionar</a></li>
