	...
	<div class="pageWrap">
		...
		<div class="pageContent extended">
			<div class="container">
				...
				<div class="box rte">
					<h2 class="boxHeadline">Formatos</h2>
					<h3 class="boxHeadlineSub">Generador de Formatos</h3>
<div class="row">
						...
						<div class="panel panel-default">
							...
							<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body">
									En Venezuela, la Ley Orgánica del Trabajo, los Trabajadores y Trabajadoras (LOTTT) se establece bajo unos principios fundamentalmente protectores para los trabajadores, al mismo tiempo que crea un espacio viable y rentable para una justicia social dentro del entorno laboral, tanto para obreros, empleados y empleadores.
									<hr>
									<form  method="POST" action="anticipoPSociales.php" >
									<input type="text" name="cedula" placeholder="cedula" class="form-control" required>
									<input type="number"  name="monto" placeholder="Monto a solicitar numero" class="form-control" required>
									<input type="text" name="monto_texto" placeholder="Monto escrito ejp:cien mil bolivar exactos" class="form-control" required>

									<input type="text" name="objeto" placeholder="Objeto de esta solicitud" class="form-control" required>
							...
							<div class="panel-heading" role="tab" id="headingTwo">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
										Dolor sit amet voluptates donor paribus
									</a>
								</h4>
							</div>
							...
							<div class="panel-heading" role="tab" id="headingFour">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
										Lorem ipsum dolor sit amet voluptates donor paribus
									</a>
								</h4>
							</div>
