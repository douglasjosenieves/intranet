...
$resul =  mysql_query("SELECT * FROM form_fichas_opciones where  exclusivo = '1' and anulado <> 1 and nombre_opcion like '%".$texto."%'  ");
	...
	<li><a href="?tipo=editar&id=<?php echo $opciones['contacto'][$i]['ref']  ?>&sector=<?php echo $opciones['contacto'][$i]['sector']  ?>"><?php echo $opciones['contacto'][$i]['ref'].' '.$opciones['contacto'][$i]['nombre_opcion']  ?></a></li>
